            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-8 col-md-6 col-sm-8 text-center">
                    <div class="section-header" data-aos="fade-up" data-aos-duration="1200">
                        <h2 class="section-title">Galeria de <span>Eventos</span></h2>
                    </div>
                </div>
            </div>
            <div class="gallery-filter-wrapper">
                ...
                <div class="grid">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (10).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (11).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (12).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (13).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (14).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (15).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (16).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (17).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (18).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (19).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (20).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (21).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (22).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (23).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (24).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (25).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (26).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (27).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
                    ...
                    <div class="grid-item competicao">
                        <div class="gallery-item">
                            <div class="gallery-thumb">
                                <img src="{{ asset('assets/images/blog/a (28).jpg') }}" alt="gallery">
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        <h4 class="title">WJJC</h4>
                                        <div class="gallery-icon">
