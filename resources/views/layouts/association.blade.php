...
@section('title', 'The WJJC Portugal Association')
@section('description', 'The WJJC Portugal Association')
    ...
    <div class="breadcrumb-area">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('messages.association.wjjc-association') }}</li>
            </ol>
        </nav>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                ...
                <div class="col-xl-6 col-lg-6 mb-30">
                    <div class="about-content-area">
                        <div class="section-header">
                            ...
                            <p> {{ __('messages.association.world_association') }}</p>
